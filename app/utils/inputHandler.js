...
app.inputHandler = (function(){
    ...
    function accelerometerUpdate(e) {
        ...
        if(Math.abs(e.rotationRate.alpha) > eps)
            alpha = e.rotationRate.alpha;
        if(Math.abs(e.rotationRate.beta) > eps)
            beta = e.rotationRate.beta;

        /*if(Math.abs(e.acceleration.z/80) > eps)
            aZ = -e.acceleration.z;*/
    ...
    function bindFullScreen(element){
