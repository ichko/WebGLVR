...
app.gl = (function(){
	...
	function gl(config) {
		this.canvas = config.canvas || document.getElementById(config.canvasId || 'canvas');
	...
	function getContext(canvas, props){
		var context = canvas.getContext("webgl", {antialias: true, preserveDrawingBuffer: true});
		if (!context)
